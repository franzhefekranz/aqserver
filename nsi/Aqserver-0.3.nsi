...
!define PRODUCT_PUBLISHER "Taxis Instruments"
!define PRODUCT_WEB_SITE "https://taxis-instruments.de"
...
Section "Hauptgruppe" SEC01
  ...
  SetOutPath "$DOCUMENTS\Aqserver\de\"
  File "..\dist\de\aqserver.chm"
  CreateShortCut "$SMPROGRAMS\Aqserver\Help.lnk" "$DOCUMENTS\Aqserver\de\aqserver.chm"
  File "..\dist\de\aqserver.pdf"
  SetOutPath "$DOCUMENTS\Aqserver\en\"
...
Section Uninstall
  ...
  Delete "$DOCUMENTS\Aqserver\en\aqserver.pdf"
  Delete "$DOCUMENTS\Aqserver\en\aqserver.chm"
  Delete "$DOCUMENTS\Aqserver\de\aqserver.pdf"
  Delete "$DOCUMENTS\Aqserver\de\aqserver.chm"
  ...
  RMDir "$INSTDIR"
  RMDir "$DOCUMENTS\Aqserver\en\"
  RMDir "$DOCUMENTS\Aqserver\de\"
